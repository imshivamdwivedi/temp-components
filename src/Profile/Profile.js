        ...
        <div className="row">
          <div className="col-6">
            <div className="row mt-5">
              ...
              >
                <div
                  className="position-absolute bottom-0 pe-2"
                  style={{ right: "0" }}
                >
                  <svg
              ...
              <div className="col-6 ml-5 ps-4 mt-4">
                <div
                ...
                >
                  ...
                  <span
                    ...
                    style={{ color: "black", fontSize: "14px", height: "24px" }}
                  >
                    4.5
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      ...
                      height="16"
                      fill="Green"
                      className="bi bi-star-fill ms-1 mb-1"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <div className="col-3">
                    ...
                    >
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-instagram mb-1"
                        viewBox="0 0 16 16"
                      >
            ...
            <div className="row mt-5">
              <div className="col-4">
                ...
                >
                  <div style={{ fontSize: "28px" }} className="my-2">
                    <b>
                      200+
                      <br />
                      Students
